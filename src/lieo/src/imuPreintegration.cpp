...
public:
    ...
    tf::TransformListener tfListener;      //68 69 80-93行表示监听激光坐标系和基坐标系的tf变换，并赋值给lidar2Baselink
    ...
    */
    TransformFusion()
    {
        ...
        // ros::TransportHints().tcpNoDelay()使用没延迟的TCP传输
        subLaserOdometry = nh.subscribe<nav_msgs::Odometry>("lieo/mapping/odometry", 5, &TransformFusion::lidarOdometryHandler, this, ros::TransportHints().tcpNoDelay());
    ...
    */
    void imuOdometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg)
    {
        ...
        //这里也算一个深坑了，实际上是lidar2Baselink是指Baselink到lidar的变换，但是下面用了右乘所以也对，
        //正常应该是tCur = (lidar2Baselink)-1 * tCur;即lidar下的坐标左乘lidar到Baselink的变换
        if(lidarFrame != baselinkFrame)
