...
public:
    ...
    */
    void allocateMemory()
    {
        ...
        cloudInfo.startRingIndex.assign(N_SCAN, 0);//assign用法：https://blog.csdn.net/doubleintfloat/article/details/52280481
    ...
    */
    void findRotation(double pointTime, float *rotXCur, float *rotYCur, float *rotZCur)
    {
        *rotXCur = 0; *rotYCur = 0; *rotZCur = 0;
        ...
        //当pointTime与imuTime[imuPointerFront]比较接近时，退出循环，否则imuPointerFront++，
        //直到当pointTime与imuTime[imuPointerFront]近似一致
        ...
        if (pointTime > imuTime[imuPointerFront] || imuPointerFront == 0)
        {
            ...
            *rotZCur = imuRotZ[imuPointerFront];
            ...
            // 前后时刻插值计算当前时刻的旋转增量
            //假设pointTime与imuTime[imuPointerBack]时间之差为3，与imuTime[imuPointerFront]时间之差为7，
            //则pointTime时刻激光点的运动更接近imuTime[imuPointerBack]时刻，因此激光点的旋转应为
            //imuPointerBack时刻的旋转乘7/10+imuPointerFront时刻的旋转乘3/10
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            if (rowIdn % downsampleRate != 0)
                continue;
            //https://blog.csdn.net/weixin_43478877/article/details/108692267
            //在雷达系下从第二象限顺时针依次为45，135，-135，-45
